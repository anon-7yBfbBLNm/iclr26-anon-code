...
base_path = '/content/drive/My Drive/ICLR 2026/Datasets/CASIA/'
trails = range(1, 6)
train_datasets = {}
test_datasets = {}

for trail in trails:
    train_file = f'CASIA_train_trail_{trail}.csv'
    test_file = f'CASIA_test_trail_{trail}.csv'
...
csv_path = os.path.join(curr_path, "casia_meta_results_2.csv")
