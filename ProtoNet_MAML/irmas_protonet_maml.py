...
base_path = '/content/drive/My Drive/ICLR 2026/Datasets/IRMAS/'
trails = range(1, 6)
...
for trail in trails:
    train_file = f'IRMAS_train_trail_{trail}.csv'
    test_file = f'IRMAS_test_trail_{trail}.csv'
...
csv_path = os.path.join(curr_path, "irmas_meta_results.csv")
