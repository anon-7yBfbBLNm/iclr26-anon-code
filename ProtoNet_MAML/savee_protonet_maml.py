...
base_path = '/content/drive/My Drive/ICLR 2026/Datasets/SAVEE/'
trails = range(1, 11)
train_datasets = {}
test_datasets = {}

for trail in trails:
    train_file = f'SAVEE_train_trail_{trail}.csv'
    test_file = f'SAVEE_test_trail_{trail}.csv'
...
csv_path = os.path.join(curr_path, "savee_meta_results.csv")
