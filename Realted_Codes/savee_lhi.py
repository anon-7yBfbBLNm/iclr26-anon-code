...
def plotPCA(data, normalizaion_bit, label_column_name, label_num, label_names, legend_title, marker_size, marker_opacity):
    ...
    fig = sns.scatterplot(
        ...
        palette=sns.color_palette("Paired",n_colors=label_num),
        data=data,
        legend="full",
        s = marker_size,
...
df = pd.read_csv("SAVEE-480.csv",index_col=0)
...
label_num = 7
label_names = ['surprise','anger','disgust','fear','happiness','neutral','sadness']
